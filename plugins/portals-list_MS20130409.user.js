...
// @description    [jonatkins-2013-04-01-223509] Display a sortable list of all localized portails with team, level, resonators informations
   ...
   //headers
    ...
    $.each(portals, function(ind, portal) {
        ...
        if (filter === 0 || filter === portal.team){
            ...
            // Morgan : add reso owner and level to CSV output
            $.each([0, 1, 2, 3 ,4 ,5 ,6 ,7], function(ind, slot) {
                
                csv += '\t' + portal.resonators[slot][1] + '[' + portal.resonators[slot][0] + ']';
